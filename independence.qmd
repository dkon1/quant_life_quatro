...
![Example of two events inside a sample space that are mutually exclusive](ch6/indep_ex1.png) ![Example of two events inside a sample space that are partially overlapping](ch6/indep_ex2.png)
