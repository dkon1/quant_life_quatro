...
%  };
  ...
  \begin{scope}[nodes = {draw = none}]
    ...
    \path (A)     -- (B) node [near start, left]  {$0.9$};
    \path (A)     -- (C) node [near start, right] {$0.1$};
    \path (Start) -- (D) node [near start, right] {$0.1$};
    \path (D)     -- (E) node [near start, left]  {$0.9$};
    \path (D)     -- (F) node [near start, right] {$0.1$};
    \begin{scope}[nodes = {below = 11pt}]
      \node [name = X] at (B) {$0.81$};
      \node            at (C) {$0.09$};
      \node [name = Y] at (E) {$0.09$};
      \node            at (F) {$0.01$};
    \end{scope}
