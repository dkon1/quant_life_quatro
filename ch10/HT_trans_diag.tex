...
\begin{tikzpicture}
[every node/.style={inner sep=0pt}]
\node (17) [circle, minimum size=50.0pt, fill=cyan, line width=1.875pt, draw=black] at (125.0pt, -87.5pt) {\textcolor{black}{\large H}};
\node (18) [circle, minimum size=50.0pt, fill=magenta, line width=1.875pt, draw=black] at (125.0pt, -175.0pt) {\textcolor{black}{\large T}};
...
\node at (92pt, -136pt) {\textcolor{black}{\large 0.5}};
\node at (163pt, -137pt) {\textcolor{black}{\large 0.5}};
\node at (125.0pt, -240pt) {\textcolor{black}{\large 0.5}};
\node at (125.0pt, -22pt) {\textcolor{black}{\large 0.5}};
\end{tikzpicture}
\end{document}